...
chaincodeQuery ${APP_CHANNEL} 4 0 ${CC_NAME} ${CC_QUERY_ARGS} 100
...
chaincodeQuery ${APP_CHANNEL} 3 0 ${CC_NAME} ${CC_QUERY_ARGS} 90
chaincodeQuery ${APP_CHANNEL} 4 0 ${CC_NAME} ${CC_QUERY_ARGS} 90

#Invoke on chaincode on Peer1/Org2
echo_b "Sending invoke transaction on org2/peer3..."
chaincodeInvoke ${APP_CHANNEL} 4 0 ${CC_NAME} ${CC_INVOKE_ARGS}
